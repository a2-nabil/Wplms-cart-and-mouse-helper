...
class UserProfile
{
    ...
    public function getUserData()
    {
        if (is_user_logged_in()) {
            ...
            $query = $wpdb->prepare(
                "SELECT u.display_name, m1.meta_value AS first_name, m2.meta_value AS last_name,m3.meta_value AS contact_number, m4.meta_value AS user_image
                ...
                LEFT JOIN {$wpdb->prefix}usermeta AS m3 ON u.ID = m3.user_id AND m3.meta_key = 'contact_number'
    ...
    public function updateUserData($form_data)
    {
        ...
        $contact_number = isset($form_data['phone']) ? sanitize_text_field($form_data['phone']) : '';
    ...
    public function updateUserEmailNotification($data)
    {
        ...
        $new_value = $formData['update_all_meta'];
    ...
    public function getMetaValue()
    {
        ...
        foreach ($meta_keys as $meta_key) {
            $metaVal = get_user_meta($user_id, $meta_key, true);
        }
        return $metaVal;
    }
}
