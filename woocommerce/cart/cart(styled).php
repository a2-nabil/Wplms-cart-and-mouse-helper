		...
		<div class="col-md-8">
			<form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
				...
				if (class_exists('WooCommerce')) {
					...
					$specific_product = wc_get_product(340);
								...
								if (!WC()->cart->find_product_in_cart(WC()->cart->generate_cart_id($specific_product_id))) {
									...
									<tr class="a2n-product__content">
										...
										<td class="product-quantity" data-title="<?php _e('Quantity', 'woocommerce'); ?>">
											...
											<a class="SpecificAddToBasket"
												href="<?php echo get_site_url(); ?>/cart/?add-to-cart=<?php echo $specific_product_id; ?>">Add
												to Basket</a>
										</td>
										<td></td>
									</tr>
								...
								<?php if (wc_coupons_enabled()) { ?>
									<div class="coupon">
										<label for="coupon_code">
											...
											value="" placeholder="<?php esc_attr_e('Coupon code', 'woocommerce'); ?>" /> <button
	...
	<script>
		...
		function enableButton() {
			...
			if (button) {
				...
				console.log("Nabil bhai er code kaj kore");
			}
		}
