...
if (function_exists('WC') && version_compare(WC()->version, "3.8.0", ">=")) {
	...
	<div class="row">
		<div class="col-md-8">
								...
								<tr
									...
									<td class="product-quantity" data-title="<?php _e('Quantity', 'woocommerce'); ?>">
										...
										if ($_product->is_sold_individually()) {
											...
											$product_quantity = sprintf('<input type="hidden" name="cart[%s][qty]" value="%d" />', $cart_item_key, $quantity);
										} else {
			...
			// Check if the jsVariable is set in the POST request
			if (isset($_POST['jsVariable'])) {
				// Retrieve JavaScript variable value from AJAX request
				$phpVariable = $_POST['jsVariable'];
				// Now you can use $phpVariable in your PHP code
				echo "Received from JavaScript: " . $phpVariable;
			} else {
				// Handle case where jsVariable is not set
				echo "Error: jsVariable is not set in the POST request.";
			}
			?>
